        ...
        <Grid item xs={12} sm={6} md={4}>
          ...
          <CustomCard variant="elevation" riseOnHover>
            ...
            <Typography variant="body1">
              ...
              people with poor credit history, no fixed address or similar unusual circumstances.
              Silverchip developed and maintain their web and mobile online banking apps, working
              alongside industry-standard APIs provided by Suits Me’s fintech partners. The app was
              required to be fully PEN-tested by a third-party service before release.
            </Typography>
            <Typography variant="body1">
