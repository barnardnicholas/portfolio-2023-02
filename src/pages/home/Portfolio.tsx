    ...
    >
      ...
      <Grid container spacing={2}>
        <Grid item xs={12} sm={6} md={4}>
          <MouseTiltContainer>
            <CustomCard variant="elevation" sx={{ alignItems: 'flex-start' }}>
          ...
          <MouseTiltContainer>
            <CustomCard variant="elevation" sx={{ alignItems: 'flex-start' }}>
              ...
              <Typography variant="body1" sx={{ mb: 3 }}>
                ...
                short demo choose-your-own-adventure-story, and see the debug information as you
                play. I may turn this into an NPM package for people to use in the future. For now
                it's a prototype.
              </Typography>
              <Typography variant="body1" sx={{ mb: 3 }}>
          ...
          <MouseTiltContainer>
            <CustomCard variant="elevation" sx={{ alignItems: 'flex-start' }}>
              ...
              <Typography variant="body1">
                ...
                B-Movie ‘Plan 9 From Outer Space’ on Twitter, one frame at a time, over the course
                of a year, possibly setting a record for the longest movie screening in history.
                Built during the first Covid lockdown using Node, ExpressJS, Firebase, React and
                Twitter.
              </Typography>
              <Typography variant="body1">
          ...
          <MouseTiltContainer>
            <CustomCard variant="elevation" sx={{ alignItems: 'flex-start' }}>
              ...
              <Typography variant="body1" sx={{ mb: 3 }}>
                ...
                the pins with red twine. Ideal for those looking to catch serial killers, or those
                who are serial killers. Built using React, Node and Firebase.
              </Typography>
              <Typography variant="body1" sx={{ mb: 3 }}>
        ...
        <Grid item xs={12} sm={6} md={4}>
          <MouseTiltContainer>
            <CustomCard variant="elevation" sx={{ alignItems: 'flex-start' }}>
              ...
              <Typography variant="body1" sx={{ mb: 3 }}>
                Fun retro point & click adventure game, produced as a birthday card for a friend.
                Play time is approx. 60 mins. Created in 2015 using Adventure Game Studio, Adobe
                Creative Cloud and Cubase with self-created art, animation & sound assets.
              </Typography>
              <Typography variant="body1" sx={{ mb: 3 }}>
